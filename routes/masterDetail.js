	...
	try {
		...
		waterfall([
			...
			function(result, callback) {
				var guid = uuidv4();
				var columns = '"name", "body__c", "heroku_master_detail_poc__c", "heroku_master_poc__c__master_external_id__c", "detail_external_id__c"';
				var values = '$1, $2, $3, $4, $5';
				var data = ['Detail1-' + name, 'Detail1-' + body__c, result.id, result.master_external_id__c, guid];
			...
			function(result, callback) {
				...
				var columns = '"name", "body__c", "heroku_master_detail_poc__c", "heroku_master_poc__c__master_external_id__c", "detail_external_id__c"';
				var values = '$1, $2, $3, $4, $5';
				var data = ['Detail2-' + name, 'Detail2-' + body__c, result.id, result.master_external_id__c, guid];
